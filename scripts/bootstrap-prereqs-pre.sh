...
echo ""
echo "Next steps:"
echo "  1. Commit and push your mcaps-infra/ changes to your feature branch"
echo "  2. Set the TF_STATE_SA repo variable, then let CD apply the spoke stack"
echo "     (or run terraform locally in mcaps-infra/ with the remote backend)"
