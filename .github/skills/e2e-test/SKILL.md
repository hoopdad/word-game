...
2. **API scope consent**: `api://<set-after-provision>/access_as_user`
...
```bash
./scripts/e2e-test.sh word-game-waf.<set-after-provision>.centralus.azurecontainerapps.io
```
...
╚══════════════════════════════════════════════════════════════╝
  Target: https://word-game-waf.<set-after-provision>.centralus.azurecontainerapps.io
