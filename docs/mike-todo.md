...
4. Define polling behavior for waiting users (interval, backoff, max wait, server load limits).
...
13. Clarify which Azure resources are allowed public control-plane access exceptions, if any, under “public network disabled”.
